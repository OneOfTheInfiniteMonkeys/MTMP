...
[![Language](https://img.shields.io/static/v1?label=CircuitPython&message=7.1.0&color=blueviolet&style=flat-square)]https://circuitpython.org/board/adafruit_magtag_2.9_grayscale/
[![Language](https://img.shields.io/static/v1?label=CircuitPython&message=7.1.1&color=blueviolet&style=flat-square)]https://circuitpython.org/board/adafruit_magtag_2.9_grayscale/
...
- If electing to use alternate CircuitPython releases <a href="https://github.com/adafruit/circuitpython/releases" target="_blank"> e.g. CircuitPython 6.3.x, 7.1.x etc.</a> you need to replace the lib .mpy files with the release counterparts in the lib folder.
